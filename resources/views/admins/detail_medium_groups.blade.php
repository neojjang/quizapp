        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="mx-auto">
                <div class="flex justify-between items-center py-4">
                    <span>
                        <a href="{{route('editMediumGroup',$mediumGroup->id)}}" class="tracking-wide font-bold rounded border-2 border-green-500 hover:border-green-500 bg-green-500 text-white hover:bg-green-600 transition shadow-md py-2 px-6 items-center">수업 중분류 수정</a>
                        <a href="{{route('createClassRoomWithMediumGroup',$mediumGroup->id)}}" class="tracking-wide font-bold rounded border-2 border-blue-500 hover:border-blue-500 bg-blue-500 text-white hover:bg-blue-600 transition shadow-md py-2 px-6 items-center">수업 생성</a>
                    </span>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="text-sm text-gray-900">
                                                    <a href="{{route('detailMajorGroup',$mediumGroup->major_group->id)}}" class="tracking-wide font-bold rounded border-2 border-blue-500 hover:border-blue-500 bg-blue-500 text-white hover:bg-blue-600 transition shadow-md py-2 px-6 items-center">{{ $mediumGroup->major_group->name }}</a>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="text-sm text-gray-900">{{ $mediumGroup->name }}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="px-6 py-4 ">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="text-sm text-gray-900">{{ $mediumGroup->description}}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="px-6 py-4 ">
                                            ...
                                            <td class="px-6 py-4 ">
                                                <div class="text-sm text-gray-900">{{ $mediumGroup->is_active === '1'  ? 'Yes' : 'No' }}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="px-6 py-4">
                                            ...
                                            <td class="px-6 py-4 ">
                                                <div class="text-sm text-gray-900">{{ $mediumGroup->details }}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="px-6 py-4 ">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="text-sm text-gray-900">{{ $mediumGroup->user->name}}</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody class="capitalize bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="hover:bg-green-100">
                                            ...
                                            <td class="sm:flex align-middle justify-center items-center px-6 py-1 text-right text-sm font-medium">
                                                ...
                                                <form action="{{route('deleteClassRoom',$section->id)}}" method="post" onsubmit="return deleteSection('{{ $section->name}}'); return false;">
                                                    @csrf
