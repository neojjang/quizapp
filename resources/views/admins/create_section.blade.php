                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <form action="{{route('storeSection', $classRoom->id)}}" method="post">
                            ...
                            <label class="block">
                                ...
                                <span class="text-red-700 text-xs content-end float-right">{{$message}}</span>
                                @enderror
                                <select name="section[type_id]" value="{{ old('section.type_id') }}" class="block w-1/2 mt-1 text-xs  bg-gray-200 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0">
