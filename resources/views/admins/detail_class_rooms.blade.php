        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="mx-auto">
                <div class="flex justify-between items-center py-4">
                    <span>
                        <a href="{{route('editClassRoom',$classRoom->id)}}" class="tracking-wide font-bold rounded border-2 border-green-500 hover:border-green-500 bg-green-500 text-white hover:bg-green-600 transition shadow-md py-2 px-6 items-center">수업 수정</a>
                        <a href="{{route('createSection',$classRoom->id)}}" class="tracking-wide font-bold rounded border-2 border-blue-500 hover:border-blue-500 bg-blue-500 text-white hover:bg-blue-600 transition shadow-md py-2 px-6 items-center">시험 생성</a>
                    </span>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr>
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="text-sm text-gray-900">
                                                    ...
                                                    <a href="{{route('detailMajorGroup',$classRoom->medium_group->major_group->id)}}" class="tracking-wide font-bold rounded border-2 border-blue-500 hover:border-blue-500 bg-blue-500 text-white hover:bg-blue-600 transition shadow-md py-2 px-6 items-center">{{ $classRoom->medium_group->major_group->name }}</a>
                                                    &gt;
                                                    <a href="{{route('detailMediumGroup',$classRoom->medium_group->id)}}" class="tracking-wide font-bold rounded border-2 border-blue-500 hover:border-blue-500 bg-blue-500 text-white hover:bg-blue-600 transition shadow-md py-2 px-6 items-center">{{ $classRoom->medium_group->name }}</a>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 ">
                                                <div class="text-sm text-gray-900">{{ $classRoom->is_active === '1'  ? 'Yes' : 'No' }}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="px-6 py-4">
